 ...
 **************************************************************************/
#ifndef RAPICBWHEELDROPSENSOR_H
#define RAPICBWHEELDROPSENSOR_H
 ...
 * index 0 = left wheel, index 1 = right wheel, index 2 = caster wheel
 * @author Jens Waweral
 */
class CCBWheelDropSensor : public ABinarySensorArray
{
  ...
  public:
     ...
     */
    CCBWheelDropSensor ( CCBDriver* driver, std::string devName );
    /** Default destructor */
    ~CCBWheelDropSensor();
    /**
