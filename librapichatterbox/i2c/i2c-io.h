...
//---------------------------------------------------------------------------
/**
*   The I2C_IO_GET_LPF_ADC command reads the low pass filtered adc channel
*/

#define I2C_IO_GET_LPF_ADC 0x0B

//---------------------------------------------------------------------------
/**
*   The I2C_IO_SET_LPF_TAU command sets the time constant for the low pass filter
*/
typedef struct
{
...
#define I2C_IO_SET_LPF_TAU 0x0C
